...
class AnalysesView(BaseView):
    ...
    def __init__(self, context, request):
        ...
        self.columns = {
            ...
            'Result': {'title': _('Result'),
                       ...
                       'sortable': False},
            'ConvertedResult': {'title': _('Converted Result'),
                                'input_width': '6',
                                'input_class': 'ajax_calculate numeric',
                                'sortable': False},
            'Uncertainty': {'title': _('+-')},
            ...
            'retested':
                {'title':
                    "<img src='++resource++bika.lims.images/retested.png'"
                    " title='%s'/>" % _('Retested'),
                 'type': 'boolean'},
    ...
    def folderitems(self):
        ...
        analysis row to be rendered in the list. The array returned is
        sorted in accordance with the layout positions set for the
        analyses this worksheet contains when the analyses were added in
        the worksheet.
        ...
        # can be generated by making use of a WorksheetTemplate, so there
        # is the chance that some slots of this worksheet being empty.
        # We need to render a row still, at lest to display the slot
        # number (Pos)
        ...
        # (AnalysisRequest, ReferenceSample), so the information about
        # the parent must be displayed in the first cell of each slot.
    ...
    def get_uids_strpositions(self):
        ...
        the uid of the analysis and the value is an string representation
        of the full position of the analysis within the list:
