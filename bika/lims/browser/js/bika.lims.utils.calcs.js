...
(function() {
  ...
  window.CalculationUtils = (function() {
    ...
    CalculationUtils.prototype.on_result_change = function(event) {
       ...
       */
      var el, field, form, interims, item_data, results, uid, value;
    ...
    CalculationUtils.prototype.clear_alerts = function(element, field, value, item_data, uid) {
    ...
    CalculationUtils.prototype.collect_form_results = function() {
      ...
      var results;
      results = {};
      $.each($("td:not(.state-retracted) input[interim='true'], td:not(.state-retracted) input[field='Result'], td:not(.state-retracted) select[field='Result']"), function(i, e) {
